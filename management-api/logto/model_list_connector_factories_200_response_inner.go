...
// checks if the ListConnectorFactories200ResponseInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListConnectorFactories200ResponseInner{}
...
type _ListConnectorFactories200ResponseInner ListConnectorFactories200ResponseInner
...
func NewListConnectorFactories200ResponseInner(type_ string, id string, target string, name map[string]interface{}, description map[string]interface{}, logo string, logoDark NullableString, readme string, platform NullableString) *ListConnectorFactories200ResponseInner {
	this := ListConnectorFactories200ResponseInner{}
	this.Type = type_
	this.Id = id
	this.Target = target
	this.Name = name
...
func (o *ListConnectorFactories200ResponseInner) UnmarshalJSON(data []byte) (err error) {
	...
	varListConnectorFactories200ResponseInner := _ListConnectorFactories200ResponseInner{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varListConnectorFactories200ResponseInner)

	if err != nil {
		return err
	}

	*o = ListConnectorFactories200ResponseInner(varListConnectorFactories200ResponseInner)

	return err
}

type NullableListConnectorFactories200ResponseInner struct {
	value *ListConnectorFactories200ResponseInner
	isSet bool
}

func (v NullableListConnectorFactories200ResponseInner) Get() *ListConnectorFactories200ResponseInner {
	return v.value
}

func (v *NullableListConnectorFactories200ResponseInner) Set(val *ListConnectorFactories200ResponseInner) {
	v.value = val
	v.isSet = true
}

func (v NullableListConnectorFactories200ResponseInner) IsSet() bool {
	return v.isSet
}

func (v *NullableListConnectorFactories200ResponseInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListConnectorFactories200ResponseInner(val *ListConnectorFactories200ResponseInner) *NullableListConnectorFactories200ResponseInner {
	return &NullableListConnectorFactories200ResponseInner{value: val, isSet: true}
}

func (v NullableListConnectorFactories200ResponseInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListConnectorFactories200ResponseInner) UnmarshalJSON(src []byte) error {
	v.isSet = true

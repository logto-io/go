...
// checks if the CreateHookTestRequestConfig type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateHookTestRequestConfig{}
...
type _CreateHookTestRequestConfig CreateHookTestRequestConfig
...
func NewCreateHookTestRequestConfig(url string) *CreateHookTestRequestConfig {
	this := CreateHookTestRequestConfig{}
	this.Url = url
	return &this
}
...
func (o *CreateHookTestRequestConfig) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateHookTestRequestConfig := _CreateHookTestRequestConfig{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCreateHookTestRequestConfig)

	if err != nil {
		return err
	}

	*o = CreateHookTestRequestConfig(varCreateHookTestRequestConfig)

	return err
}

type NullableCreateHookTestRequestConfig struct {
	value *CreateHookTestRequestConfig
	isSet bool
}

func (v NullableCreateHookTestRequestConfig) Get() *CreateHookTestRequestConfig {
	return v.value
}

func (v *NullableCreateHookTestRequestConfig) Set(val *CreateHookTestRequestConfig) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateHookTestRequestConfig) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateHookTestRequestConfig) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateHookTestRequestConfig(val *CreateHookTestRequestConfig) *NullableCreateHookTestRequestConfig {
	return &NullableCreateHookTestRequestConfig{value: val, isSet: true}
}

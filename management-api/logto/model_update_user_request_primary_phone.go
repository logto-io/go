...
func (dst *UpdateUserRequestPrimaryPhone) UnmarshalJSON(data []byte) error {
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("data matches more than one schema in oneOf(UpdateUserRequestPrimaryPhone)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("data failed to match schemas in oneOf(UpdateUserRequestPrimaryPhone)")
	}
}
...
type NullableUpdateUserRequestPrimaryPhone struct {
	value *UpdateUserRequestPrimaryPhone
	isSet bool
}

func (v NullableUpdateUserRequestPrimaryPhone) Get() *UpdateUserRequestPrimaryPhone {
	return v.value
}

func (v *NullableUpdateUserRequestPrimaryPhone) Set(val *UpdateUserRequestPrimaryPhone) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateUserRequestPrimaryPhone) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateUserRequestPrimaryPhone) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateUserRequestPrimaryPhone(val *UpdateUserRequestPrimaryPhone) *NullableUpdateUserRequestPrimaryPhone {
	return &NullableUpdateUserRequestPrimaryPhone{value: val, isSet: true}
}
